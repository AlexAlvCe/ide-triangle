...
public final class Encoder implements Visitor {
  ...
  public Object visitIfCommand(IfCommand ast, Object o) {
    ...
    Addrs.add(nextInstrAddr);
    emit(Machine.JUMPop, 0, Machine.CBr, 0);
    patch(jumpifAddr, nextInstrAddr);
    }
    ast.C.get(ast.C.size()-1).visit(this, frame);
    for (Integer JmpIfAddr : Addrs) {
          patch(JmpIfAddr, nextInstrAddr);
    }
    return null;
 }
  ...
  public Object visitForDoCommand(ForDo ast, Object o) {
        ...
        int evalCondition, loopAddr;
        
        Frame frame = (Frame) o;
        int extraSize;  
        int valSize = ((Integer) ast.E2.visit(this, frame)).intValue();
        System.err.println("E2"+ ast.E2);
        ast.entity = new UnknownValue(valSize, frame.level, frame.size);
        extraSize =  valSize;
        writeTableDetails(ast);
        
        
        Frame fram2 = new Frame(frame, extraSize);
        
        int extraSize2 = ((Integer) ast.R.visit(this, fram2)).intValue();
        
        Frame fram3 = new Frame(fram2, extraSize2);
        
        evalCondition = nextInstrAddr;
        
        emit(Machine.JUMPop, 0, Machine.CBr, 0);
        
        loopAddr = nextInstrAddr;
        
        ast.C1.visit(this, fram3);
        
        emit(Machine.CALLop, Machine.SBr, Machine.PBr, Machine.succDisplacement);
        
        patch(evalCondition,nextInstrAddr);
  ...
  @Override
    public Object visitForWhileCommand(ForWhileCommand ast, Object o) {
        ...
        Frame frame3 = new Frame(fram2, extraSize);
        ...
        int valSize3 = ((Integer) ast.E3.visit(this, frame3)).intValue();
        ast.entity= new UnknownValue(valSize, frame3.level, frame3.size);
        extraSize = valSize3;
        writeTableDetails(ast);
        Frame frame4 = new Frame(frame3, extraSize);
        int out = nextInstrAddr;
        emit (Machine.JUMPIFop, Machine.falseRep,Machine.CBr,0);

        ast.C1.visit(this, frame4);
        patch(out, nextInstrAddr); 
        emit(Machine.CALLop, Machine.SBr, Machine.PBr, Machine.succDisplacement);
  ...
  public Object visitBinaryExpression(BinaryExpression ast, Object o) {
    ...
    ast.O.visit(this, frame2);
      System.err.println("valsize = "+valSize);
    return valSize;
  }
  ...
  public Object visitVarDeclaration(VarDeclaration ast, Object o) {
   ...
   @Override
    public Object visitVarDeclarationEXP(VarDeclarationEXP ast, Object o) {
        ...
        if (ast.E instanceof CharacterExpression) {
          CharacterLiteral CL = ((CharacterExpression) ast.E).CL;
          ast.entity = new KnownValueInitialized(Machine.addressSize,
                  frame.level,
                  frame.size,
                  characterValuation(CL.spelling)
          );
  ...
  public Object visitIdentifier(Identifier ast, Object o) {
    Frame frame = (Frame) o;
    System.err.println("que pasa"+ast.spelling);
    if (ast.decl.entity instanceof KnownRoutine) {
        System.err.println("amonos");
...
///////////////////////////////////////////////////////
  ...
  @Override
    ...
    public Object visitcompoundDeclRecursive(compoundDeclRecursive ats, Object o) {
        ...
        valSize = (Integer) ats.P.visit(this, frame);
    ...
    extraSize1 = ((Integer) ast.D1.visit(this, frame)).intValue();
    Frame frame1 = new Frame (frame, extraSize1);
        for (Declaration D2 : ast.LD) {
            extraSize1 += ((Integer) D2.visit(this, frame1)).intValue();
        }
    ...
    @Override
    public Object visitInDeclaration(InDeclaration aThis, Object o) {return null;}

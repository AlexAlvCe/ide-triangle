...
public class LayoutVisitor implements Visitor {
  ...
  private Polyline bridge (Polyline line1, int x1, int y1,
    ...
    public Object visitForDoCommand(ForDo ast, Object o) {
        return layoutQuaternary("Repeat For Do.", ast.R.I,ast.R.E,ast.E2,ast.C1);
    }

    @Override
    public Object visitForWhileCommand(ForWhileCommand ast, Object o) {
        ArrayList<AST> childs = new ArrayList<>();
        childs.add(ast.R.I);childs.add(ast.R.E);childs.add(ast.E2);childs.add(ast.E3);childs.add(ast.C1);
    ...
    public Object visitForInCommand(ForInCommand ast, Object o) {
          return layoutTernary("Repeat For In", ast.I.I, ast.I.E, ast.C);
    }
    ...
    public Object visitPro_funcs(Pro_funcs ast, Object o) {
        ...
        return layoutBinary("Proc or Func",ast.D1,ast.D2);
    }
    ...
    @Override
    public Object visitRangeDecl(RangeDeclaration aThis, Object o) {
        return null;
    }

    @Override
    public Object visitInDeclaration(InDeclaration aThis, Object o) {
        return null;
    }
